...
class TestAssignPeopleToItems(unittest.TestCase):
    ...
    @patch('main.genai_legacy.configure')
    @patch('main.genai_legacy.types')
    ...
    def test_assign_people_to_items_success(self, mock_get_dynamic_config, 
        ...
        # Create mock generative model response using genai types directly
        ...
        # Patch genai_legacy types directly
        with patch('main.genai_legacy.GenerativeModel') as mock_genai_model_constructor:
