...
class FirestoreService {
  ...
  Future<DocumentSnapshot> getReceipt(String receiptId) async {
    return await receiptsCollection.doc(receiptId).get();
  }
  ...
  Future<QuerySnapshot> getReceipts({String? status}) async {
    Query query = receiptsCollection.orderBy('metadata.updated_at', descending: true);
  ...
  Future<QuerySnapshot> getReceiptsPaginated({
    ...
    Query query = receiptsCollection.orderBy('metadata.updated_at', descending: true).limit(limit);
  ...
  Future<String> saveReceipt({
    ...
    try {
      ...
      if (receiptId == null) {
        ...
        docRef = await receiptsCollection.add(dataToSave);
        ...
        docRef = receiptsCollection.doc(receiptId);
